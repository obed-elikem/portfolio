...
export const EXPERIENCES = [
  {
    ...
    role: "Web Developer",
    company: "Freelance",
    description: `Successfully designed and developed a fully responsive front-end website for a client. Utilized HTML and CSS to ensure optimal functionality and user experience across various devices and screen sizes.`,
  ...
  },
  {
    ...
    company: "Accra Technical University",
    description: `Developed a MySQL database with a table for storing member information. Configured a data source in IntelliJ, created a Java user interface for member sign-up, and implemented JDBC to connect and store member data in the database.`,
